window.__PROJECTS_DATA__ = {
  "items": [
    ...
    {
      "timeline": "",
      "coverImage": "assets/img/ChatGPT_Image_Aug_9__2026__07_02_08_AM.png",
      "logo": "",
      "slug": "northline-builders-logo-concepts",
      "client": "Northline Builders LLC",
      "featured": false,
      "order": 18,
      "mockups": [
        {
          "image": "assets/img/ChatGPT_Image_Aug_9__2026__07_02_08_AM.png",
          "alt": "Three NB monogram logo concepts for Northline Builders LLC, each combining a house roof, hammer and blue-and-gray color scheme, shown on signage and paper mockups"
        },
        {
          "image": "assets/img/northline-builders-final-logos.png",
          "alt": "Three refined Northline Builders LLC NB monogram logo variations shown in Adobe Illustrator"
        }
      ],
      "colors": [
        {
      ...
      "coverAlt": "Three NB monogram logo concepts for Northline Builders LLC, each combining a house roof, hammer and blue-and-gray color scheme, shown on signage and paper mockups",
      "gallery": [],
      "deliverables": [
        ...
        "Printed Materials",
        "Digital Platforms",
        "3D Wall Presentations",
        "Brand Collateral"
      ],
      "title": "Northline Builders Logo Concepts",
      "tools": [
        "Adobe Illustrator"
      ],
      "description": "Three NB monogram logo concepts for a construction and homebuilding company, combining a house roof and hammer with a blue-and-gray color scheme.",
      "category": "Logo Design",
      "overview": "A strong, professional, and memorable logo was designed for Northline Builders LLC, combining the brand initials \u201cN\u201d and \u201cB\u201d with architectural and construction elements.",
      "brief": "To create a visual identity that positions Northline Builders LLC as a reliable, established, and professional construction company, while ensuring the logo remains recognizable even when used independently as a monogram.",
      "goal": "The N is integrated with a house-roof structure to represent residential construction, while the B reinforces the \u201cBuilders\u201d identity. A hammer element represents construction expertise and craftsmanship, and architectural forms communicate both commercial and residential building services. The monogram was designed to remain recognizable across different sizes and applications.",
      "personality": [
        "Modern",
        "Bold",
        "Professional",
    ...
    {
      "timeline": "",
      "coverImage": "assets/img/EXQUISITE_GRAPHICS_.png",
      "logo": "",
      "slug": "exquisite-graphics-logo-design",
      "client": "Exquisite Graphics",
      "featured": false,
      "order": 19,
      "mockups": [
        {
          "image": "assets/img/EXQUISITE_GRAPHICS_.png",
          "alt": "Exquisite Graphics E and G monogram logo shown in six alternate color palettes on dark backgrounds"
        },
        {
          "image": "assets/img/exquisite-graphics-color-variations.png",
          "alt": "Exquisite Graphics E and G monogram logo shown across eight color and background variations in Adobe Illustrator"
        }
      ],
      "colors": [
        {
      ...
      "coverAlt": "Exquisite Graphics E and G monogram logo shown in six alternate color palettes on dark backgrounds",
      "gallery": [],
      "deliverables": [
        "Digital Branding",
      ...
      "title": "Exquisite Graphics Logo Design",
      "tools": [
        "Adobe Illustrator"
      ],
      "description": "A geometric E+G monogram logo for Exquisite Graphics, designed with six alternate color palettes for flexible brand application.",
      "category": "Logo Design",
      "overview": "A minimal, contemporary, and distinctive logo was developed for Exquisite Graphics, with the identity centered around a geometric monogram and clean typography.",
      "brief": "To create a distinctive and flexible visual identity that reflects the creativity of Exquisite Graphics while maintaining a professional, modern, and memorable brand presence.",
      "goal": "The logo mark combines abstract representations of the initials \u201cE\u201d and \u201cG\u201d using geometric lines and simplified forms for a modern, sophisticated appearance. The \u201cEXQUISITE GRAPHICS\u201d wordmark is paired with the symbol using clean typography, with horizontal line elements visually connecting the monogram to the wordmark. The simplified construction keeps the logo clear and recognizable across different sizes.",
      "personality": [
        "Minimal",
        "Creative",
        "Modern",
    ...
    {
      "timeline": "",
      "coverImage": "assets/img/ADJFHQEUGR42U_JPG.png",
      "logo": "",
      "slug": "blueberry-vs-funded-squad-youtube-thumbnail",
      "client": "",
      "featured": false,
      "order": 20,
      "mockups": [
        {
          "image": "assets/img/ADJFHQEUGR42U_JPG.png",
          "alt": "YouTube thumbnail comparing Blueberry and Funded Squad prop trading firms with a 'Which is Best?' headline and host photo"
        }
      ],
      "colors": [],
      "coverAlt": "YouTube thumbnail comparing Blueberry and Funded Squad prop trading firms with a 'Which is Best?' headline and host photo",
      "gallery": [
        {
          "image": "assets/img/blueberry-funded-squad-thumbnail-psd.png",
          "alt": "Blueberry vs Funded Squad YouTube thumbnail design shown in the Adobe Photoshop layers panel"
        }
      ],
      "deliverables": [],
      "title": "Blueberry vs Funded Squad YouTube Thumbnail",
      "tools": [
        "Adobe Photoshop"
      ],
      "description": "A YouTube thumbnail comparing the Blueberry and Funded Squad prop trading firms for a forex trading mentor channel.",
      "category": "Social Media Design"
    }
  ]
};
